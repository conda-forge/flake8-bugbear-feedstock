About flake8-bugbear-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flake8-bugbear-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flake8-bugbear-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flake8-bugbear
# for installing globally
pixi global install flake8-bugbear
```
...
It is possible to list all of the versions of `flake8-bugbear` available on your platform:
...
```
pixi search flake8-bugbear --channel conda-forge
```
